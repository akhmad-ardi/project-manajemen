    ...
    <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
      <div class="col-lg-8 align-self-end">
        <h1 class="text-white fw-light">
          Manage Proyek Anda menggunakan [<span class="fw-bold">Kelola</span>]
        </h1>
        <hr class="divider" />
      </div>
  ...
  <div class="container px-4 px-lg-5">
    <div class="row gx-4 gx-lg-5 justify-content-center">
      <div class="col-lg-8 text-center">
        ...
        <a class="btn btn-light btn-xl me-3" href="<?php echo base_url() ?>/signup">Daftar</a>
        <a class="btn btn-light btn-xl" href="<?php echo base_url() ?>/signin">Masuk</a>
      </div>
    </div>
  </div>
</section>
